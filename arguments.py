"""
The document is used for tracking the training arugments value and its meaning.
"""
...
class ModelArguments:
    ...
    num_labels: int = field(
        default=0,
        metadata={
            "help": "The dimension of the output, depends on the number of items to recommend"
        }
    )
